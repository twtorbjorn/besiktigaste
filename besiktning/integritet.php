...
<head lang="en">
    <meta charset="utf-8">
    <meta name="description" content="Besiktigaste.se erbjuder tjänster till ägare eller skötare av fastigheter i behov av att genomföra fastighetsrelaterat arbete. Läs om hantering av personuppgifter">
    <meta name="keywords" content="PUL, personuppgifter, kontaktinformation, besiktning, fastighetstjänster">
    
    <meta name="viewport" content="width=1100, minimal-ui">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Besiktigaste.se - integritet, sekretesspolicy och PUL</title>
	<link rel="alternate" media="only screen and (max-width: 640px" href="http://m.besiktigaste.se/besiktning/integritet.php">
    ...
    <div class="topicMenu">
      ...
      <div class="contentNytr">
        ...
        <div class="rightContentNytr text-left">
            <label class="faqTitle serviceTitle">Sekretesspolicy & hantering av personuppgifter</label>
...
Oavsett vilket ärende du har, och vill komma i kontakt med RättRådig, använd denna kontaktinformation: info@miljonline.se.
            ...
            <div class="articlesBlock">
                ...
                <a href="#userName" class="faqQuestion articlesLink">Besiktigaste.se ägarinformation</a>
                <div class="faqAnswer articlesText">
					...
					Vill du komma i kontakt med oss, vänligen använd kontaktformuläret på sidan "Kontakta oss" eller ring. 

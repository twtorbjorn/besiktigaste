...
<head lang="en">
<meta name="description" content="Tjänsterna som besiktigaste.se erbjuder till fastighetsägare kännetecknas av effektivitet,  lokalt fokus, omdömen från andra, gratis och kvalitet ">
    <meta name="keywords" content="kontaktinformation, ägare, offertförfrågan, besiktning, fastighetstjänster, besiktigaste.se">
    <meta charset="utf-8">
    <meta name="viewport" content="width=1100, minimal-ui">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Besiktigaste.se - besiktning i superlativ. Om oss</title>
	<link rel="alternate" media="only screen and (max-width: 640px" href="http://m.besiktigaste.se/besiktning/om-oss.php">
    ...
    <div class="headerContent">
        ...
        <nav>
                <span class="headerText">
                    <a href="/besiktning/om-oss.php" class="headerLink headerLinkActive">Om oss</a>
...
<main>
    ...
    <div class="contentNytr">
        ...
        <div class="rightContentNytr text-left">
            <label class="faqTitle serviceTitle">Om besiktigaste.se</label>
             <div class="articlesBlock">
                <a href="#userName" class="faqQuestion articlesLink">Om tjänsten</a>
                <div class="faqAnswer articlesText">Besiktigaste.se tillhandahåller en gratis och högkvalitativ tjänst till dig som äger eller representerar ägare av en fastighet där människor vistas och som behöver genomföra en OVK (obligatorisk ventilationskontroll). Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade funktionskontrollanter. Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar. Även om du är van att få OVK utfört kan en offertförfrågan till fler leverantörer ge dig nya insikter om priser, kringtjänster och ev nyheter inom marknaden. 
				</div>
            ...
            <div class="articlesBlock">
                ...
                <div class="faqAnswer articlesText">
                    Besiktigaste.se ägs av RättRådig Digitala Affärer i Sverige. Tjänsten drivs av personal på Stockholmsbaserade miljonline.se vilka har varit verksamma inom digitala affärer sedan 1999. Vill du komma i kontakt med oss, vänligen använd kontaktformuläret, email eller ring. 
            ...
            <label class="faqTitle serviceTitle">Besiktigaste.se - leverantörslöftet</label>
                ...
                <div>
                  <ul class="mainUl">
                      ...
                      <li class="mainLiText"><strong>Omdömen</strong> - Beställare och leverantörer får och ger omdömen </li>
  					  <li class="mainLiText"><strong>Kvalitetsstämpel</strong> - På besiktigaste.se finns endast certifierade leverantörer</li>

...
<head lang="en">
    <meta charset="utf-8">
    <meta name="description" content="Besiktigaste.se erbjuder tjänster med bra kvalitet till ägare eller skötare av fastigheter med hissar som regelbundet behöver få hiss-besiktning genomförd">
    <meta name="keywords" content="hiss-besiktning, hisskontroll, besiktning, fastighetsskötare, fastighetsägare, offert, leverantör">
    <meta name="viewport" content="width=1100, minimal-ui">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Hiss-besiktning - välj en bra leverantör med besiktigaste.se </title>
	<link rel="alternate" media="only screen and (max-width: 640px" href="http://m.besiktigaste.se/hiss-besiktning/">
...
<div id="post"></div>
    ...
    <main>
    <div class="topicMenu">
        <div class="topicMenuImgKeyGirl">
            <div class="tabPanel">
                <!-- Nav tabs -->
                <ul class="nav nav-tabs" id="myTab">
                    <li><a href="/ovk-besiktning/"><span class="iconArray downArray"></span>OVK-besiktning</a></li>
                    <li class="active"><a><span class="iconArray rightArray"></span>Hissbesiktning</a></li>
                    ...
                    <div role="tabpanel" class="tab-pane active" id="newBoiler" data-serviceId="91439">
                        <span class="boxText">Be om offert</span>
                         ...
                         <!-- Tab panes <div class="btn-group dropdownBoil orange firstForm">-->
                            ...
                            <label class="boxText inputLabel">Antal hissar</label>
                            <input type="text" name="AntalHissar" class="boxArea inputField orange" data-id="333" placeholder="Skriv antal hissar i fastigheten"/>
                        
                       	 	<img src="/assets/images/alert.png" class="alertBox alertInput">
                        
                            <label class="boxText inputLabel">Övrig relevant information</label>
                            <!-- <textarea placeholder="Skriv övrig info som kan vara relevant" name="additionalInfo1" data-id="444" class="boxArea inputField orange"></textarea>-->
							 <input type="textarea" name="additionalInfo1" class="boxArea inputField orange" data-id="454" placeholder="Ev relevant info"/>
     ...
     <div>
        <div class="mainText">
            <div class="mainTextLeft">
                <div class="title1">Hiss-besiktning</div>
			    ...
			    Exempelvis: 
                  ...
                  <ul class="mainUl">
                    ...
                    <li>Vad kostar hiss-besiktningen?</li>
                    <li>Hur prissätts hissbesikning av leverantörerna? </li>
                    <li>Vad påverkar tid och kostnad för besiktningen? </li>
                    <li>Vilka kringtjänster till hissbesiktningar finns? </li>
                    <li>Ska jag välja samma leverantör till besiktningen som att utföra service av hissen? </li>
                    <li>Vad ska jag tänka på i samband med åtgärdande av fel och brister som påträffas i besiktningen?</li>
				...
				<div class="textFragment">Normalt sett behöver hiss-kontrollanterna bara veta några uppgifter för att ta fram en offert till dig.
				 <br><br>Förutom dina kontaktuppgifter anger du bara:
                  ...
                  <ul class="mainUl">
        			...
        			<br><br>
        	        När du har skickat in uppgifterna kommer ett eller flera företag att höra av sig till dig med en offert. Du jämför erbjudanden och väljer om du vill beställa hiss-besiktningen. Allt är gratis för dig. 
					<br><br>
				</div>
            </div>

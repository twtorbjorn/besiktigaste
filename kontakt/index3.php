...
<head lang="en">
    <meta charset="utf-8">
    <meta name="description" content="Besiktigaste.se erbjuder tjänster till ägare eller representanter till fastigheter där människor vistas och som behöver utföra OVK, energideklaration, hus- eller hissbesiktning">
...
<body>
  ...
  <!--   <img src="/assets/images/100000.png" class="logo100">-->
			...
			<div class="row">&nbsp;</div>
			    ...
			    <div class="container-fluid">
					 <div class="row">
					 	  ...
					 	  <div class="col-md-4">
						  	   <div class="row">
							   		<h3 class="title2">Det här säger användarna</h3>
							   <p>
		...
		<?php include $root . '/assets/scripts/footerMenuLightblue2.php';
		?> 

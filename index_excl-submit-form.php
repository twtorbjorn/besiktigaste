...
(function () {
 if (document.addEventListener) {
    ...
    s.async = true;s.src = "//d191y0yd6d0jy4.cloudfront.net/sitegainer_5616330.js?cb="+cb;
    ...
    <meta name="description" content="Need a Architect? Get up to 5 free quotes here. Quick & easy">
    <meta name="keywords" content="boiler prices, Architect, condensing boiler, combination boilers, boiler install">
...
<!--
                    ...
                    <li><a href="/energi-deklaration/"><span class="iconArray rightArray"></span>Energideklaration</a></li>
-->
                </ul>
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="newBoiler" data-serviceId="91439">
                        <span class="boxText">Be om offert</span>			
	                    <span class="boxTextLight">Normalt sett behöver OVK-kontrollanterna bara veta några uppgifter för att ta fram en offert till dig. 

                              <br><br>Förutom dina kontaktuppgifter anger du bara:<br>
                              - Fastighetsägare<br>
                              - Fastighetsbeteckning<br>
                              - Fastighetens adress<br>
                              - Hur många lägenheter som finns i fastigheten<br>
                              - Typ av existerande ventilation (S, F, FT, FX, FTX)<br><br>
                              Tjänsten fungerar även för dig som är privatperson och om det gäller ditt bostadshus. <br>
                        ...
                        <a href="mailto:info@besiktigaste.se" class="boxTextButtonLight">Ge mig offert gratis<img src="/assets/images/arrayButton.png" class="boxButtonArray"></a>
     ...
     <div>
        <div class="mainText">
            <div class="mainTextLeft">
                <div class="title1">OVK-besiktning</div>
                ...
                <div>
                  <ul class="mainUl">
                      ...
                      <li class="mainLiText"><strong>Lokalt</strong> - Leverantörer runtom i hela Sverige</li>

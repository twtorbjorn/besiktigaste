...
<head lang="en">
    <meta charset="utf-8">
	<meta name="description" content="Hitta ett företag som utför energideklaration i Västmanland. Se en översikt över besiktningsmän, certifierade enegiexperter (CEX), deras företags inriktning inom ventilation och läs andras omdömen.">
    ...
    <title>Energideklaration Västmanland - certifierade besiktningsmän, se pris</title>
    ...
    <div class="headerContent">
		...
		<nav>      
                <span class="headerBreadcrumb">
                    <a href="https://besiktigaste.se/energideklaration/örebro-län/" class="headerLink">Västmanland</a>
...
<div class="title2">Vilka uppgifter behöver vi av dig?</div>
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">Energideklaration i Västmanland</h1>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud FROM Companies WHERE latitud !=  '' AND region = 'Västmanland' AND company_presentation = 'cex'";
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
				...
				<a href="https://besiktigaste.se/energideklaration/örebro-län/">Energideklaration i Västmanland</a></strong><br>
				...
				energideklaration. 
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade energiexperter verksamma i Västmanland. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 class="h2">Certifierade energiexperter (CEX) i Västmanland</h2>
			 <div id="results-wrapper">
				...
				<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND region = 'Västmanland' AND company_presentation = 'cex'";
                    $result = $conn->query($sql);	

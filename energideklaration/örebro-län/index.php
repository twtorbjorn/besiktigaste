...
<head lang="en">
    <meta charset="utf-8">
	<meta name="description" content="Hitta ett företag som utför energideklaration i Örebro län. Se en översikt över besiktningsmän, certifierade enegiexperter (CEX), deras företags inriktning inom ventilation och läs andras omdömen.">
    ...
    <title>Energideklaration Örebro län - certifierade besiktningsmän, se pris</title>
    ...
    <div class="headerContent">
		...
		<nav>      
                <span class="headerBreadcrumb">
                    <a href="https://besiktigaste.se/energideklaration/örebro-län/" class="headerLink">Örebro län</a>
                    <!-- <a href="https://besiktigaste.se/energideklaration/malmö/" class="headerLink">/ Malmö</a>
                    <a href="https://besiktigaste.se/energideklaration/helsingborg/" class="headerLink">/ Helsingborg</a>
                    <a href="https://besiktigaste.se/energideklaration/kristianstad/" class="headerLink">/ Kristianstad</a>-->
        ...
        <div class="topicMenuNytrMapImg">
            <div class="tabPanel">
                ...
                <ul class="nav nav-tabs" id="myTab">
                     <li><a href="https://besiktigaste.sehttps://besiktigaste.se/ovk-besiktning/"><span class="iconArray rightArray"></span>OVK-besiktning</a></li>
                    <li><a href="https://besiktigaste.sehttps://besiktigaste.se/hiss-besiktning/"><span class="iconArray rightArray"></span>Hissbesiktning</a></li>
			...
			<div><h2 class="h2">Varför använda tjänsten besiktigaste.se?</h2></div>
                <div>
                  <ul class="mainUl">
                      ...
                      <li class="mainLiText"><strong>Lokalt</strong> - Leverantörer certifierade i Örebro län</li>
...
<div class="title2">Vilka uppgifter behöver vi av dig?</div>
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">Energideklaration i Örebro län</h1>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND region = 'Örebro län' AND company_presentation = 'cex' order by overallrating desc";
    ...
    <script>
      ...
      function initMap() {
        var map = new google.maps.Map(document.getElementById('map'), {
          zoom: 8,
          center: {lat: 59.4133, lng: 14.9180}
        });
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
				...
				<a href="https://besiktigaste.se/energideklaration/örebro-län/">Energideklaration i Örebro län</a></strong><br>
				...
				energideklaration. 
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade energiexperter verksamma i Örebro län. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 class="h2">Certifierade energiexperter (CEX) i Örebro län</h2>

...
<head lang="en">
    <meta charset="utf-8">
	<meta name="description" content="Hitta ett företag som utför energideklaration i Gävleborg. Se en översikt över besiktningsmän, certifierade enegiexperter (CEX), deras företags inriktning inom ventilation och läs andras omdömen.">
    ...
    <title>Energideklaration Gävleborg - certifierade energiexperter</title>
    ...
    <div class="headerContent">
		...
		<nav>      
                <span class="headerBreadcrumb">
                    <a href="https://besiktigaste.se/energideklaration/Gävleborg/" class="headerLink">Gävleborg</a>
			...
			<div><h2 class="h2">Varför använda tjänsten besiktigaste.se?</h2></div>
                <div>
                  <ul class="mainUl">
                      ...
                      <li class="mainLiText"><strong>Lokalt</strong> - Leverantörer certifierade i Gävleborg</li>
...
<div class="title2">Vilka uppgifter behöver vi av dig?</div>
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">Energideklaration i Gävleborg</h1>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud FROM Companies WHERE latitud !=  '' AND region = 'Gävleborg' AND company_presentation = 'cex'";
    ...
    <script>
      ...
      function initMap() {
        var map = new google.maps.Map(document.getElementById('map'), {
          zoom: 7,
          center: {lat: 61.2476, lng: 16.5943}
        });
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
				...
				<a href="https://besiktigaste.se/energideklaration/Gävleborg/">Energideklaration i Gävleborg</a></strong><br>
				...
				energideklaration. 
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade energiexperter verksamma i Gävleborg. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 class="h2">Certifierade energiexperter (CEX) i Gävleborg </h2>
			 <div id="results-wrapper">
				...
				<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND region = 'Gävleborg' AND company_presentation = 'cex'";
                    $result = $conn->query($sql);	

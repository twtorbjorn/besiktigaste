...
<head lang="en">
    <meta charset="utf-8">
	<meta name="description" content="Hitta ett företag som utför energideklaration i Västra Götaland län. Se en översikt över besiktningsmän, certifierade enegiexperter (CEX), deras företags inriktning inom ventilation och läs andras omdömen.">
    <meta name="keywords" content="energideklaration, hiss-besiktning, besiktningsman, energideklaration, besiktning, fastighetsskötare, leverantör">
    
    <meta name="viewport" content="width=1100, minimal-ui">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Energideklaration Västra Götaland - certifierade besiktningsmän, se pris</title>
    ...
    <div class="headerContent">
		...
		<nav>      
                <span class="headerBreadcrumb">
                    <a href="/energideklaration/västra-götaland/" class="headerLink">Västra Götaland</a>
                    <!-- <a href="/energideklaration/malmö/" class="headerLink">/ Malmö</a>
                    <a href="/energideklaration/helsingborg/" class="headerLink">/ Helsingborg</a>
                    <a href="/energideklaration/kristianstad/" class="headerLink">/ Kristianstad</a>-->
        ...
        <div class="topicMenuNytrMapImg">
            <div class="tabPanel">
                ...
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li class='active'><a href="/energideklaration/"><span class="iconArray rightArray"></span>Energideklaration</a></li>
                </ul>
                <!-- Tab panes -->
				<?php include $root . '/assets/scripts/energideklarationServiceForm.php';
  				?> 
            </div>
        </div>
    </div>
...
<div class="title2">Vilka uppgifter behöver vi av dig?</div>
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">Energideklaration i Västra Götaland</h1>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud FROM Companies WHERE latitud !=  '' AND region = 'Västra Götaland' AND company_presentation = 'cex'";
    ...
    <script>
      ...
      function initMap() {
        var map = new google.maps.Map(document.getElementById('map'), {
          zoom: 8,
          center: {lat: 58.08, lng: 12.68}
        });

        setMarkers(map);

		marker.addListener('click', function() {
          window.location.href = 'http://besiktigaste.se/energideklaration/varberg/';
        });
      }
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
				...
				<a href="/energideklaration/västra-götaland/">Energideklaration i Västra Götaland</a></strong><br>
				<!--<a href="/energideklaration/malmö/">energideklaration Malmö</a><br>
				<a href="/energideklaration/helsingborg/">energideklaration Helsingborg</a><br>
				<a href="/energideklaration/kristianstad/">energideklaration Kristianstad</a><br><br>-->
				...
				energideklaration. 
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade energiexperter verksamma i Västra Götaland. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 class="h2">Certifierade energiexperter (CEX) i Västra Götaland </h2>
			 <div id="results-wrapper">
				...
				<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND region = 'Västra Götaland' AND company_presentation = 'cex'";
                    $result = $conn->query($sql);	

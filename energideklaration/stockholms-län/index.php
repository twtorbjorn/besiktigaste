...
<head lang="en">
	...
	<link rel="canonical" href="https://besiktigaste.sehttps://besiktigaste.se/energideklaration/stockholm/">
...
<div class="title2">Vilka uppgifter behöver vi av dig?</div>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud FROM Companies WHERE latitud !=  '' AND region = 'Stockholms län' AND company_presentation = 'cex'";
        ...
        <div class="rightContentLocal text-left">
			 ...
			 <div id="results-wrapper">
				...
				<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND region = 'Stockholms län' AND company_presentation = 'cex'";
                    $result = $conn->query($sql);	

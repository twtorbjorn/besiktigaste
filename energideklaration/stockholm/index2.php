    ...
    <div class="headerContent">
		...
		<nav>      
                <span class="headerBreadcrumb">
                    <a href="/energideklaration/stockholm/" class="headerLink">Stockholms län</a>
                </span>
        </nav>
...
<div class="title2">Vilka uppgifter behöver vi av dig?</div>
      ...
      function setMarkers(map) {
        ...
        for (var i = 0; i < beaches.length; i++) {
		  ...
		  google.maps.event.addListener(marker, 'click', function() {
	        ...
	        var beaches = [  
        	['Energideklaration Franska Bukten AB', 59.312, 18.061, 2291, '/assets/images/5-stars-icon.png', '/energideklaration/stockholm/franskabukten/'],  
			<?php 
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
				...
				<a href="/energideklaration/stockholm/">Energideklaration i Stockholms län</a></strong><br>

...
<head lang="en">
    <meta charset="utf-8">
  	<meta name="description" content="Hitta ett företag som utför energideklaration i Stockholms län. Se en översikt över besiktningsmän, certifierade enegiexperter (CEX), deras företags inriktning inom ventilation och läs andras omdömen.">
    ...
    <title>Energideklaration Stockholms län - certifierade energiexperter</title>
    ...
    <div class="headerContent">
		...
		<nav>      
                <span class="headerBreadcrumb">
                    <a href="https://besiktigaste.se/energideklaration/stockholm/" class="headerLink">Stockholms län</a>
                </span>
        </nav>
...
<div class="title2">Vilka uppgifter behöver vi av dig?</div>
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">Energideklaration i Stockholms län</h1>
    ...
    <script>
      ...
      function initMap() {
        var map = new google.maps.Map(document.getElementById('map'), {
          zoom: 9,
          center: {lat: 59.3244, lng: 18.0194}
        });
      ...
      function setMarkers(map) {
        ...
        for (var i = 0; i < beaches.length; i++) {
		  ...
		  google.maps.event.addListener(marker, 'click', function() {
	        ...
	        var beaches = [  
        	['Energideklaration Franska Bukten AB', 59.312, 18.061, 2291, '/assets/images/5-stars-icon.png', 'https://besiktigaste.se/energideklaration/stockholm/franskabukten/'],  
			<?php 
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
				...
				<a href="https://besiktigaste.se/energideklaration/stockholm/">Energideklaration i Stockholms län</a></strong><br>
				...
				energideklaration. 
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade energiexperter verksamma i Stockholms län. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 class="h2">Certifierade energiexperter (CEX) i Stockholms län </h2>
			 <div id="results-wrapper">
				...
				<?php
					...
					include $root . '/assets/scripts/certifieradeTabell2.php';
					                    
                    $conn->close();
                ?>
                  </table>
				  <label class="textUnderTable">*Om stjärnorna i kolumnen "Omdöme" inte är klickbara finns det för få omdömen och default <span style='color: orange;'><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star-o'></i><i class='fa fa-star-o'></i><i class='fa fa-star-o'></i></span> visas</label>
				  <br>

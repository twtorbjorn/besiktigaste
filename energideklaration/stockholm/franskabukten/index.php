...
<head lang="en">
    <meta charset="utf-8">
	<meta name="description" content="Franska Bukten AB i Stockholm är ett modernt konsult- och serviceföretag som utfärdar energideklarationer till BRF:er och andra fastighetsägare.">
    ...
    <title>Franska Bukten AB i Stockholm - energideklaration och OVK</title>
...
<main>
	...
	<div class="leftContentNytr2">
        ...
        <div class="rightContentMap text-left">
    			 <h1 class="h1">Franska Bukten AB &nbsp;&nbsp;<span style='color: orange;'><i class='fa fa-star'></i> <i class='fa fa-star'></i> <i class='fa fa-star'></i> <i class='fa fa-star'></i> <i class='fa fa-star'></i></span></h1>
			 <h4 class="title4">Vi hjälper BRF:er, fastighetsägare och privatpersoner med energideklaration, energianalys och energiberäkningar.</h4>			
				<div class="faqAnswer articlesText">
				AB Franska Bukten är ett modernt konsult- och serviceföretag inom fastighetsteknik med ca 20 konsulter. Förutom energideklarationer och OVK gör vi energiberäkningar och entreprenader. 
				<br><br>
                ...
                <br><br>
				Varje år gör vi över tvåhundra besiktningar av fastigheter i Stockholmsområdet. Vi har 2 certifierade energiexperter (CEX) som använder de mest avancerade programmen och är pålästa gällande aktuella krav och regler. 
         ...
         <div class="leftContentNytrCompany">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item carousel-indicators-bottom active">
                        ...
                        <div class="quotes-comments">
                                <p class="carusel-text">Förutom energideklarationen fick vi rekommendationer om förbättringar som sparade oss uppvärminingskostnader.
                        <img src="/assets/images/quotes.png"></p><br>
								
                                <p class="carusel-text black"><b>Elsa Holmberg, Stockholm</b></p>
                         </div>
            ...
            <div class="articlesBlock">
                ...
                <div class="faqAnswer articlesText">
					<table><tr><td class='textCompanyPres'>CEX-certifierad:</td><td class='textCompanyPres'> Jonas Karlsson </td></tr>
					<tr><td class='textCompanyPres'>Telefon:</td><td class='textCompanyPres'>073-821 32 17</td></tr>
					<tr><td class='textCompanyPres'>Email:</td><td class='textCompanyPres'><a href='mailto:jonas.karlsson@franskabukten.se'>Kontakta oss</a></td></tr>

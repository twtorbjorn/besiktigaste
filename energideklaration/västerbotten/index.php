...
<head lang="en">
    <meta charset="utf-8">
	<meta name="description" content="Hitta ett företag som utför energideklaration i Västerbotten. Se en översikt över besiktningsmän, certifierade enegiexperter (CEX), deras företags inriktning inom ventilation och läs andras omdömen.">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
      <title>Energideklaration Västerbotten - certifierade energiexperter</title>
    ...
    <div class="headerContent">
		...
		<nav>      
                <span class="headerBreadcrumb">
                    <a href="https://besiktigaste.se/energideklaration/västerbotten/" class="headerLink">Västerbotten</a>
                </span>
        </nav>
...
<div class="title2">Vilka uppgifter behöver vi av dig?</div>
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">Energideklaration i Västerbotten</h1>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud FROM Companies WHERE latitud !=  '' AND region = 'Västerbotten' AND company_presentation = 'cex'";
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
				...
				<a href="https://besiktigaste.se/energideklaration/västerbotten/">Energideklaration i Västerbotten</a></strong><br>
				...
				energideklaration. 
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade energiexperter verksamma i Västerbotten. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 class="h2">Certifierade energiexperter (CEX) i Västerbotten </h2>
			 <div id="results-wrapper">
				...
				<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND region = 'Västerbotten' AND company_presentation = 'cex'";
                    $result = $conn->query($sql);	

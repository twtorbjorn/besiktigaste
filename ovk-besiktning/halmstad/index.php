...
<head lang="en">
    <meta charset="utf-8">
    	<meta name="description" content="Hitta företag som utför OVK i Halmstadstrakten, Halland. Se översikt över ventilationskontroll och företags inriktning samt få kostnad och pris.">
    ...
    <title>OVK-besiktning i Halmstad, Halland - pris och kostnader</title>
    ...
    <div class="headerContent">
		...
		<nav>      
                <span class="headerBreadcrumb">
                    <a href="/ovk-besiktning/halland/" class="headerLink">Halland</a>
                    <a href="/ovk-besiktning/halmstad/" class="headerLink">/ Halmstad</a>
...
<main>
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane tab-pane-nytr active" id="newBoiler" data-serviceId="ovk">
                       ...
                       <span class="boxText">Offertförfrågan</span>
                          ...
                          <textarea placeholder="(T ex adress, enfamiljs- el flerfamiljs-fastighet, antal lägenheter)" name="additionalInfo" class="boxArea inputField orange"></textarea> 
    ...
    <div class="contentNytrMap">
			...
			<div><h2 class="h2">Besiktigaste.se - erbjudandet</h2></div>
                <div>
                  <ul class="mainUl">
                      ...
                      <li class="mainLiText"><strong>Lokalt</strong> - Leverantörer certifierade i Halland</li>
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">OVK-besiktning i Halmstad</h1>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND region = 'Halland' order by overallrating desc";
      ...
      function setMarkers(map) {
        ...
        for (var i = 0; i < beaches.length; i++) {
		  ...
		  google.maps.event.addListener(marker, 'click', function() {
			...
			['OVK-besiktning Halland', 55.67,13.21, 20, '/assets/images/3-stars-icon.png', '/ovk-besiktning/Halland/'],  
			<?php 
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
                  <div class="faqAnswer articlesText"><strong><a href="/ovk-besiktning/halland/">Övriga trakter i Halland</a></strong><br>
				<a href="/ovk-besiktning/halmstad/">OVK-besiktning Halmstad</a><br>
				<a href="/ovk-besiktning/varberg/">OVK-besiktning Varberg</a><br>
				<a href="/ovk-besiktning/falkenberg/">OVK-besiktning Falkenberg</a><br><br>
				...
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade funktionskontrollanter verksamma i Halmstadstrakten, Halland. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 id="OVKTable" class="h2">OVK-certifierade i trakten av Halmstad</h2>
		    ...
		    $result = $conn->query($sql);	
				   ...
				   include $includes . 'certifieradeTabell.php';
                    ...
                    $conn->close();
                ?>
                  <!--<tr class='textCertifieradeFtg'><td class='textCertifieradeFtg'><a href="/ovk-besiktning/västra-götaland/hsb-goteborg">HSB Halmstad</a> </td><td class='textCertifieradeFtg'>Halmstad </td><td class='textCertifieradeFtg'>spec</td><td class='textCertifieradeFtg'><a href="/ovk-besiktning/västra-götaland/hsb-goteborg.php"><span style='color: orange;'><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i></a></td></tr> -->
				  </table>
				  ...
				  <br><br>
				  Ovan visas några slumpvis valda företag som har OVK-certifierad personal i Halmstadstrakten. 
  			 ...
  			 <div class="title2"><h2 class="h2">Offerförfrågan - få svar på pris och kostnad</h2></div>
 			    ...
 			    Exempelvis: 
                   ...
                   <ul class="mainUl">
                     <li>Vilka leverantörer finns i Halmstadstrakten? </li>

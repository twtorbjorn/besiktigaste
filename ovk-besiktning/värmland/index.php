...
<head lang="en">
    <meta charset="utf-8">
	<meta name="description" content="Hitta ett företag som utför OVK i Värmland. Se en översikt över besiktningsmän, deras företags inriktning inom ventilation och läs andras omdömen.">
    ...
    <title>OVK-besiktning i Värmland - hitta en besiktningsman, Besiktigaste.se</title>
...
<main>
    ...
    <div class="contentNytrMap">
            ...
            <div id="carousel" class="carousel slide carouselNytr">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="item carousel-indicators-bottom">
                        <img src="/assets/images/quotes.png">
                         <div class="quotes-comments">
                                <p class="carusel-text">Vi fick in två bra offerter som vi kunde jämföra. Toppen.</p><br>
                                <p class="carusel-text black"><b>Yngve Andersson, Kristinehamn</b></p>
                            </div>
                    </div>
                </div>
            </div>
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">OVK-besiktning Värmland</h1>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND region = 'Värmland' order by overallrating desc";
      ...
      function setMarkers(map) {
        ...
        for (var i = 0; i < beaches.length; i++) {
		  ...
		  google.maps.event.addListener(marker, 'click', function() {
	        ...
	        var beaches = [ 
			['OVK-besiktning Värmland', 62.4165,14.818, 60, '/assets/images/5-stars-icon.png', '/ovk-besiktning/värmland/'],   
			<?php 
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
                <div class="faqAnswer articlesText"><strong><a href="/ovk-besiktning/värmland/">Värmland</a></strong><br><br>
				...
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade funktionskontrollanter verksamma i Värmland. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 class="h2">OVK-certifierade i Värmland</h2>
		    ...
		    include $includes . 'certifieradeTabell.php';
  			 ...
  			 <div class="title2"><h2 class="h2">Vad får du svar på i din offerförfrågan?</h2></div>
 			    ...
 			    Exempelvis: 
                   ...
                   <ul class="mainUl">
                     <li>Vilka leverantörer finns i mitt Värmland? </li>

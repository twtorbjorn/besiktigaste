...
<meta name="description" content="ETAB, Energi & Teknik i Arvika utför OVK-besiktning på ett snabbt och säkert sätt, till fastighetsägare i hela Värmland och Dalsland">
...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>ETAB - OVK-besiktning i Karlstad, Arvika och hela Värmland</title>
...
<a href="/ovk-besiktning/" class="headerLink">OVK regionalt</a>
...
<a href="/ovk-besiktning/värmland/" class="headerLink">Värmland</a>
...
<h2 class="h2">ETAB - leverantörslöftet</h2>
               
                
<div>
<ul class="mainUl">

<li class="mainLiText"><strong>Certifierade</strong> - OVK-behörighet och stora inom fastighetsunderhåll</li>
                      
<li class="mainLiText"><strong>Ekonomi</strong> - säkert och och tryggt med ekonomi</li>
                      
<li class="mainLiText"><strong>På plats</strong> - i hela Värmland och Dalsland</li>
...
<h1 class="h1">
<span style='color: orange;'><i class='fa fa-star'></i> <i class='fa fa-star'></i> <i class='fa fa-star'></i> <i class='fa fa-star'></i> <i class='fa fa-star'></i>
</span>
ETAB</h1>
			
<h4 class="title4">Energi & Teknik i Arvika - OVK och helhetslösningar för din fastighet</h4>				
				
<div class="faqAnswer articlesText">
	 
	 			ETAB har <b>certifierad personal inom OVK</B>, och arbetar med detta i hela Värmland, Dalsland och västra Dalarna/Örebro län.
				<br><br>
                Företagets huvudsakliga sysselsättning är fastighetsservice med installationer och service av ventilations- värme- och sanitetsanläggningar samt elinstallationer. Komplexa system som värme, ventilation, el, vatten och sanitet kräver lång erfarenhet och stort kunnande, något som finns hos ETAB.
				             
<br><br>
                
Några av våra tjänster inom ventilation:
<br>
                – OVK-besiktning
<br>
                – ventilationsservice
...
<br><br>
                Våra kunder uppskattar våra helhetslösningar och att arbetet alltid sköts med god kommunikation och planering.
	                
<br><br>
                Kontakta oss nu för att prata om era behov och få snabbt ett prisförslag på OVK. Ring eller maila idag.
...
<p class="carusel-text">Väldigt snabba i kontakt och genomförande
                        
<img src="/assets/images/quotes.png"></p><br>
								
                                
<p class="carusel-text black"><b>Stefan, Karlstad</b></p>
...
<a href="#userName" class="faqQuestion articlesLink">Kontaktinfo ETAB</a>
                
<div class="faqAnswer articlesText">

					
<table><tr><td class='textCompanyPres'>OVK-certifierad:</td><td class='textCompanyPres'> Niklas Johansson </td></tr>
<tr><td class='textCompanyPres'>Kontaktperson OVK:</td><td class='textCompanyPres'> Christian Foss </td></tr>
					
<tr><td class='textCompanyPres'>Telefon:</td><td class='textCompanyPres'><a href="tel:0570-72 70 94">0570-72 70 94</A></td></tr>
					
<tr><td class='textCompanyPres'>Email:</td><td class='textCompanyPres'><a href='mailto:christian.foss@energioteknik.se'>Kontakta oss</a></td></tr>
					
<tr><td class='textCompanyPres'>Adress:</td><td class='textCompanyPres'> 
							
ETAB, Energi & Teknik<br>
...
<script src="/libs/moment-timezone.min.js">
</script>

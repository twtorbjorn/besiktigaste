...
<head lang="en">
    <meta charset="utf-8">
	<meta name="description" content="Hitta ett företag som utför OVK i Blekinge län. Se en översikt över besiktningsmän, deras företags inriktning inom ventilation och läs andras omdömen.">
    ...
    <title>OVK-besiktning i Blekinge - hitta en besiktningsman, Besiktigaste.se</title>
...
<main>
    ...
    <div class="contentNytrMap">
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">OVK-besiktning Blekinge</h1>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND region = 'Blekinge'";
    ...
    <script>
      ...
      function initMap() {
        var map = new google.maps.Map(document.getElementById('map'), {
          zoom: 9,
          center: {lat: 56.2456, lng: 15.1486}
        });
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
				...
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade funktionskontrollanter verksamma i Blekinge. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 class="h2">OVK-certifierade i Blekinge</h2>
			 <div id="results-wrapper">
				...
				<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND region = 'Blekinge' order by overallrating desc";
		    $result = $conn->query($sql);	
		    ...
		    include $includes . 'certifieradeTabell.php';
  			 ...
  			 <div class="title2"><h2 class="h2">Vad får du svar på i din offerförfrågan?</h2></div>
 			    ...
 			    Exempelvis: 
                   ...
                   <ul class="mainUl">
                     <li>Vilka leverantörer finns i mitt Blekinge? </li>

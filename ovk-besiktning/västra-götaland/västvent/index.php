...
<head lang="en">
    <meta charset="utf-8">
	<meta name="description" content="Västvent utför OVK och tillhandahåller andra tjänster inom ventilation. Företaget är auktoriserad att sköta service och injustering av ventilation i fastigheter. Läs kunders omdömen om Accent VVS konsult.">
    ...
    <title>Västvent KB - utför OVK besiktning i Västra Götaland</title>
...
<main>
	...
	<div class="leftContentNytr2">
	             <h2 class="h2">Västvent - leverantörslöftet</h2>
               
                <div>
                  <ul class="mainUl">
                      <li class="mainLiText"><strong>Certifierade</strong> - OVK-besiktningar sedan år 2001</li>
                      <li class="mainLiText"><strong>Ekonomi</strong> - prisvärd OVK & ventilationsservice</li>
                      <li class="mainLiText"><strong>På plats</strong> - Göteborg, Västra Götaland, Halland</li>
                  </ul>
				</div>
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h1">Västvent KB &nbsp;&nbsp;<span style='color: orange;'><i class='fa fa-star'></i> <i class='fa fa-star'></i> <i class='fa fa-star'></i> <i class='fa fa-star'></i> <i class='fa fa-star'></i></h1>
			 <h4 class="title4">30 års erfarenhet inom ventilation - OVK, service och underhåll</h4>			
				<div class="faqAnswer articlesText">
				Västvent jobbar med er ventilation så att luftkvalitén blir bra. <br><br>
				En människa behöver minst 15 kg luft per dag. Vi ser till att luften är frisk och syrerik så att ni fungerar och mår bra.  
				<br><br>
                Vi optimerar och underhåller ventilationssystem, ser till att kanaler och flöden är rena. Boende och personer som vistas i lokalerna kommer att trivas när vi gjort OVK och ventilationsåtgärder. 
				Fastighetsägare och förvaltare har en trygg partner i oss. 
                <br><br>
                Bland våra kunder finns:<br>
                – Akademiska Hus (Chalmers)<br>
                – Chalmersfastigheter<br>
                – Östra Nordstan<br>
                – RUAG (fd.Saab Spacebyggnaden)<br>
                – LE Lundberg
                <br><br>
                Vänd er till Västvent när ni behöver utföra ventilationsrelaterade arbeten i Göteborg, Västra Götaland och norra Halland.
				</div>
         ...
         <div class="leftContentNytrCompany">
                    ...
                    <div class="item carousel-indicators-bottom active">
                        <img src="/assets/images/quotes.png">
                         <div class="quotes-comments">
                                <p class="carusel-text">Västvent kan allt inom ventilation och ser helheten, inte bara det som vi först tror är det enda problemet med våra ventilationssystem. 
</p><br>
                                <p class="carusel-text black"><b>Glenn Konradsson, Mölndal</b></p>
                         </div>
                    </div>
            ...
            <div class="articlesBlock">
                ...
                <a href="#userName" class="faqQuestion articlesLink">Kontaktinfo Västvent</a>
                <div class="faqAnswer articlesText">
					<table><tr><td class='textCompanyPres'>OVK-certifierad:</td><td class='textCompanyPres'> Ingemar Blad </td></tr>
					<tr><td class='textCompanyPres'>Telefon:</td><td class='textCompanyPres'>0705-28 35 35</td></tr>
					<tr><td class='textCompanyPres'>Email:</td><td class='textCompanyPres'>ingemar@vastvent.se</td></tr>

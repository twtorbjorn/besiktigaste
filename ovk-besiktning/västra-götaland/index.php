...
<main>
    ...
    <div class="contentNytrMap">
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">OVK-besiktning i Västergötland</h1>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND region = 'Västra Götaland' order by overallrating desc";
    ...
    <script>
      ...
      function setMarkers(map) {
        ...
        ['Västvent', 57.6369,12.300, 61, '/assets/images/5-stars-icon.png', '/ovk-besiktning/västra-götaland/västvent/'],
        ['OVK-besiktning Göteborg', 57.80,12.13, 20, '/assets/images/3-stars-icon.png', '/ovk-besiktning/göteborg/'],
        ['OVK-besiktning Skövde', 58.48,13.97, 24, '/assets/images/3-stars-icon.png', '/ovk-besiktning/skövde/'],
        ['OVK-besiktning Lidköping', 58.555,13.222, 25, '/assets/images/3-stars-icon.png', '/ovk-besiktning/skövde/'],
        ['OVK-besiktning Mariestad', 58.7122,13.828, 27, '/assets/images/3-stars-icon.png', '/ovk-besiktning/skövde/'],
        ['OVK-besiktning Borås', 57.83,13.09, 23, '/assets/images/3-stars-icon.png', '/ovk-besiktning/borås/'],
        ['OVK-besiktning Uddevalla', 58.3477, 11.9467, 28, '/assets/images/3-stars-icon.png', '/ovk-besiktning/trollhättan/'],
        ['OVK-besiktning Trollhättan', 58.42,12.50, 22, '/assets/images/3-stars-icon.png', '/ovk-besiktning/trollhättan/'],   
			<?php 
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
				...
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade funktionskontrollanter verksamma i Västergötland. 

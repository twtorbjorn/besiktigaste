...
<head lang="en">
    <meta charset="utf-8">
    	<meta name="description" content="Hitta företag som utför OVK i Växjötrakten, Kronobergs län. Se översikt över ventilationskontroll och företags inriktning samt få kostnad och pris.">
    ...
    <title>OVK-besiktning i Växjö, Kronobergs län - pris och kostnader</title>
    ...
    <div class="headerContent">
		...
		<nav>      
                <span class="headerBreadcrumb">
                    <a href="/ovk-besiktning/kronobergs-län/" class="headerLink">Kronobergs län</a>
                    <a href="/ovk-besiktning/växjö/" class="headerLink">/ Växjö</a>
...
<main>
    ...
    <div class="contentNytrMap">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item carousel-indicators-bottom active">
                        ...
                        <div class="quotes-comments">
                                <p class="carusel-text">Det går bra att resonera med OVK-konsulten, han var väldigt proffsig. </p><br>
                                <p class="carusel-text black"><b>Johan Gunnarsson, Ljungby</b></p>
                            </div>
                    </div>
                    <div class="item carousel-indicators-bottom">
                        <img src="/assets/images/quotes.png">
                         <div class="quotes-comments">
                                <p class="carusel-text">Vi fick bra översikt över priset och det låg mycket lägre än vi förväntade oss.</p><br>
                                <p class="carusel-text black"><b>Stina Eriksson, Kalmar</b></p>
                            </div>
                    </div>
                </div>
            </div>
			<div><h2 class="h2">Besiktigaste.se - erbjudandet</h2></div>
                <div>
                  <ul class="mainUl">
                      ...
                      <li class="mainLiText"><strong>Lokalt</strong> - Leverantörer certifierade i Kronobergs län</li>
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">OVK-besiktning i Växjö</h1>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND city ='Växjö' order by overallrating desc";
      ...
      function setMarkers(map) {
        ...
        for (var i = 0; i < beaches.length; i++) {
		  ...
		  google.maps.event.addListener(marker, 'click', function() {
	        ...
	        var beaches = [ 
			['Växjö ventilation AB', 56.9003,14.8157, 90, '/assets/images/5-stars-icon.png', '/ovk-besiktning/kronobergs-l%C3%A4n/v%C3%A4xj%C3%B6-ventilation/'],
        	['OVK-besiktning Kronobergs län', 55.67,13.21, 20, '/assets/images/3-stars-icon.png', '/ovk-besiktning/Kronobergs län/'],  
			<?php 
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
                  <div class="faqAnswer articlesText"><strong><a href="/ovk-besiktning/kronobergs-län/">Övriga trakter i Kronobergs län</a></strong><br>
				<a href="/ovk-besiktning/växjö/">OVK-besiktning Växjö</a><br><br>
				...
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade funktionskontrollanter verksamma i Växjötrakten, Kronobergs län. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 id="OVKTable" class="h2">OVK-certifierade i trakten av Växjö</h2>
			 <div id="results-wrapper">
				...
				<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND city ='Växjö' AND region = 'Kronobergs län' order by overallrating desc";
				   $result = $conn->query($sql);	
				   ...
				   include $includes . 'certifieradeTabell.php';
                    ...
                    $conn->close();
                ?>
                  <!--<tr class='textCertifieradeFtg'><td class='textCertifieradeFtg'><a href="/ovk-besiktning/västra-götaland/hsb-goteborg">HSB Jönköping</a> </td><td class='textCertifieradeFtg'>Jönköping </td><td class='textCertifieradeFtg'>spec</td><td class='textCertifieradeFtg'><a href="/ovk-besiktning/västra-götaland/hsb-goteborg.php"><span style='color: orange;'><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i></a></td></tr> -->
				  </table>
				  ...
				  <br><br>
				  Ovan visas några slumpvis valda företag som har OVK-certifierad personal i Växjötrakten. 
  			 ...
  			 <div class="title2"><h2 class="h2">Offerförfrågan - få svar på pris och kostnad</h2></div>
 			    ...
 			    Exempelvis: 
                   ...
                   <ul class="mainUl">
                     <li>Vilka leverantörer finns i Växjötrakten? </li>

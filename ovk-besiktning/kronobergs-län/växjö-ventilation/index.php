...
<head lang="en">
    <meta charset="utf-8">
	<meta name="description" content="Växjö ventilation med säte i Löddeköpinge utför OVK-besiktning till fastighetsägare i Kronoberg och Kalmar. Vi är specialister på bostadsventilation och ventilationslösningar ">
    ...
    <title>Växjö ventilation AB - OVK-besiktning i Kronoberg och Kalmar</title>
...
<main>
	...
	<div class="leftContentNytr2">
	             <h2 class="h2">Växjö ventilation AB - leverantörslöftet</h2>
               
                <div>
                  <ul class="mainUl">
                      <li class="mainLiText"><strong>Certifierade</strong> - OVK Riksbehörighet K</li>
                      <li class="mainLiText"><strong>Ekonomi</strong> - energieffektiva lösningar</li>
                      <li class="mainLiText"><strong>På plats</strong> - i Kronoberg, Blekinge och Kalmar (säte i Växjö)</li>
                  </ul>
				</div>
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h1">Växjö ventilation AB</h1>
			 <h4 class="title4">Vi hjälper fastighetsägare, förvaltare, företag, BRF:er och privatpersoner med OVK, injustering, service och montage.</h4>			
				<div class="faqAnswer articlesText">
				Växjö ventilation kännetecknas av det stora kunnandet som kommer med lång branscherfarenhet. Berätta om er fastighet och ventilationssystem så föreslår vi en lösning med bästa kvalitet till ett bra pris.
				<br><br>
				Huvudkontoret finns i Växjö och arbete utförs till kunder i Blekinge, Kronobergs, Jönköpings och Kalmar län.
                ...
                – energideklarationer
                <br><br>
				Växjö ventilation erbjuder er det lilla företagets unika flexibilitet och snabba resurser men också det större företagets kunnande och långsiktighet.
				<br><br>
				Du får alltid ett personligt bemötande av oss och den person som du kontaktat lämnar offert, återkopplar och kommer senare till din arbetsplats.
				</div>
         ...
         <div class="leftContentNytrCompany">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item carousel-indicators-bottom active">
                        ...
                        <div class="quotes-comments">
                                <p class="carusel-text">Vi fick bra översikt över priset och det låg mycket lägre än vi förväntade oss.
            ...
            <div class="articlesBlock">
                ...
                <a href="#userName" class="faqQuestion articlesLink">Kontaktinfo Växjö ventilation AB</a>
                <div class="faqAnswer articlesText">
					<table><tr><td class='textCompanyPres'>OVK-certifierad:</td><td class='textCompanyPres'> Patrik Karlsson </td></tr>
					<tr><td class='textCompanyPres'>Telefon:</td><td class='textCompanyPres'>0761- 39 63 32</td></tr>
					<tr><td class='textCompanyPres'>Email:</td><td class='textCompanyPres'><a href='mailto:info@vaxjoventilation.se'>Kontakta oss</a></td></tr>
					<tr><td class='textCompanyPres'>Adress:</td><td class='textCompanyPres'> 
							Växjö ventilation AB<br>
							Trumpetvägen 35<br>
							352 45 Växjö<br>
						</td></tr>
					</table>

...
$myServer = "besiktigaste-se-content-157123.mysql.binero.se";
$myUser = "157123_xp30818";
$myPass = "Bes123cont";
$myDB = "157123-besiktigaste-se-content";
...
<head lang="en">
    <meta charset="utf-8">
    <meta name="description" content="Besiktigaste.se erbjuder tjänster till ägare eller skötare av fastigheter där människor vistas och som behöver genomföra OVK (obligatorisk ventilationskontroll)">
    ...
    <title>OVK-besiktning - välj en bra OVK-leverantör med besiktigaste.se</title>
	<link rel="alternate" media="only screen and (max-width: 640px" href="http://m.besiktigaste.se/ovk-besiktning/">
...
<div id="post"></div>
    ...
    <main>
    <div class="topicMenu">
        <div class="topicMenuImgTubeMan">
            <div class="tabPanel">
                <!-- Nav tabs -->
                <ul class="nav nav-tabs" id="myTab">
                    <li class="active"><a><span class="iconArray downArray"></span>OVK-besiktning</a></li>
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="newBoiler" data-serviceId="91439">
                        <span class="boxText">Be om offert - certifierade i Göteborg</span>

                            <label class="boxText inputLabel">Fastighetsägare</label>
							<input type="text" name="Fastighetsagare" class="boxArea inputField orange" data-id="111" placeholder="Skriv vem som äger fastigheten"/>
                         ...
                         <!-- Tab panes <div class="btn-group dropdownBoil orange firstForm">-->
                            ...
                            <input type="text" name="Fastighetsbeteckning" class="boxArea inputField orange" data-id="222" placeholder="Skriv fastighetens beteckning"/>
                        
                        	<img src="/assets/images/alert.png" class="alertBox alertInput">
						
                            <label class="boxText inputLabel">Fastighetens adress</label>
                            <input type="text" name="Fastighetsadress" class="boxArea inputField orange" data-id="333" placeholder="Skriv fastighetens adress"/>
                        
                       	 	<img src="/assets/images/alert.png" class="alertBox alertInput">
                        
                            <label class="boxText inputLabel">Antal lägenheter</label>
                            <input type="text" name="noApartments" class="boxArea inputField orange" data-id="444" placeholder="Antal lägenheter (el skriv privatbostad)"/>
                       
                            <img src="/assets/images/alert.png" class="alertBox alertInput">
                   
                            <label class="boxText inputLabel">Ventilationstyp</label>
                            <div class="btn-group dropdownBoil orange firstForm">
                                <button type="button" class="btn dropdown-toggle" data-toggle="dropdown" aria-expanded="false" data-id="332358">Typ av ventilationssystem</button>
                                <button type="button" class="btn boxArray" data-toggle="dropdown" aria-expanded="false">
                                </button>
                                <ul class="dropdown-menu" role="menu">
                                    <li data-value="S-ventilation">Självdragsventilation</li>
                                    <li data-value="F-ventilation">Mekanisk frånluftsventilation</li>
                                    <li data-value="FT-ventilation">Mekanisk från- och tilluftsventilation</li>
                                    <li data-value="FX-ventilation">F-ventilation med återvinning</li>
                                    <li data-value="FTX-ventilation">FT-ventilation med återvinning</li>
                                    <li data-value="Annan-ventilation">Annan (vänligen beskriv i fältet nedan)</li>
                                 </ul>
                            </div>
                            <img src="/assets/images/alert.png" class="alertBox alertInput">
     ...
     <div>
        <div class="mainText">
            <div class="mainTextLeft">
                <h1 class="title1">OVK-besiktning Göteborg</h1>
				...
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade funktionskontrollanter verksamma i Göteborgstrakten. 
                ...
                <div>
                  <ul class="mainUl">
                      ...
                      <li class="mainLiText"><strong>Lokalt</strong> - Leverantörer certifierade i Göteborg</li>
			    ...
			    Exempelvis: 
                  ...
                  <ul class="mainUl">
                    <li>Vilka leverantörer finns i mitt Göteborgstrakten? </li>
            ...
            <div class="mainTextRight">
                <div class="title2 title3">Så här säger användarna</div>
				...
				<h2 class="h2">OVK-certifierade i Göteborg</h2>
				<div id="results-wrapper">
                  <table id="results" class="tableCertifieradeFtg">
                      <tr class="headerCertifieradeFtg">
                          <th class="headerCertifieradeFtg">Namn</th>
                          ...
                          <tr class="textCertifieradeFtg">
                                  <td class="textCertifieradeFtg">Kenneth Abildg&#229;rd</td>
                                  <td class="textCertifieradeFtg">ISAB Ventilation AB</td>
                                  <td class="textCertifieradeFtg">G&#246;teborg</td>
                                  <td class="textCertifieradeFtg">Installation</td>
                          </tr>
          
                          <tr class="textCertifieradeFtg">
                                  <td class="textCertifieradeFtg">Robert Norin</a></td>
                                  <td class="textCertifieradeFtg">Fastighets AB Balder</td>
                                  <td class="textCertifieradeFtg">G&#246;teborg</td>
                                  <td class="textCertifieradeFtg">Projektering</td>
                          </tr>
                          <tr class="textCertifieradeFtg">
                                  <td class="textCertifieradeFtg">Erik Ottosson</a></td>
                                  <td class="textCertifieradeFtg">&#197;F-Infrastructure AB</td>
                                  <td class="textCertifieradeFtg">G&#214;TEBORG</td>
                                  <td class="textCertifieradeFtg">Besiktning</td>
                          </tr>
                  </table>
...
<!--
    <div class="upperFooter">
        <div class="upperFooterInfo">
        <span class="upperFooterTitle">Boiler makes</span>
            <button id="brandCollapse" class="upperFooterButton footerButtonClose" data-toggle="collapse" data-target="#collapseBrands">See all brands</button>
        </div>
        <div>
            <div class="brandsContainer">
                <img src="/assets/brands/01.jpg" class="brands brandsLeft">
                <img src="/assets/brands/02.jpg" class="brands">
                <img src="/assets/brands/03.jpg" class="brands">
                <img src="/assets/brands/04.jpg" class="brands">
                <img src="/assets/brands/05.jpg" class="brands">
                <img src="/assets/brands/06.jpg" class="brands">
                <img src="/assets/brands/07.jpg" class="brands">
                <img src="/assets/brands/08.jpg" class="brands">
                <img src="/assets/brands/09.jpg" class="brands brandsRight">
            </div>
        </div>
        <div class="collapse" id="collapseBrands">
            <div class="brandsContainerMore">
                <img src="/assets/brands/10.jpg" class="brands brandsMore brandsLeft">
                <img src="/assets/brands/11.jpg" class="brands brandsMore">
                <img src="/assets/brands/12.jpg" class="brands brandsMore">
                <img src="/assets/brands/13.jpg" class="brands brandsMore">
                <img src="/assets/brands/14.jpg" class="brands brandsMore">
                <img src="/assets/brands/15.jpg" class="brands brandsMore">
                <img src="/assets/brands/16.jpg" class="brands brandsMore">
                <img src="/assets/brands/17.jpg" class="brands brandsMore">
                <img src="/assets/brands/18.jpg" class="brands brandsMore brandsRight">
                <img src="/assets/brands/19.jpg" class="brands brandsMore brandsLeft">
                <img src="/assets/brands/20.jpg" class="brands brandsMore">
                <img src="/assets/brands/21.jpg" class="brands brandsMore">
            </div>
        </div>
    </div>
	-->
...
<script src="/assets/scripts/main-screen.js"></script>

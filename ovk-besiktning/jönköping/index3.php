...
/*
  ...
  $sql = "SELECT person_id, first_name, last_name FROM Persons";
  $result = $conn->query($sql);
  
  if ($result->num_rows > 0) {
      // output data of each row
      while($row = $result->fetch_assoc()) {
          echo "id: " . $row["person_id"]. " - Name: " . $row["first_name"]. " " . $row["last_name"]. "<br>";
      }
  } else {
      echo "0 results";
  }
     ...
     <div>
        <div class="mainText">
            <div class="mainTextLeft">
                <h1 class="title1">OVK-besiktning Jönköpings län</h1>
				...
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade funktionskontrollanter verksamma i Jönköpings län. 
                ...
                <div>
                  <ul class="mainUl">
                      ...
                      <li class="mainLiText"><strong>Lokalt</strong> - Leverantörer certifierade i Jönköpings län</li>
			    ...
			    Exempelvis: 
                  ...
                  <ul class="mainUl">
                    <li>Vilka leverantörer finns i mitt Jönköpings län? </li>
            ...
            <div class="mainTextRight">
				...
				<div class="float-top">
				<h2 class="h2">OVK-certifierade i Jönköpings län</h2>
				...
				<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet FROM Companies";
                    $result = $conn->query($sql);
                    
				  if ($result->num_rows > 0) {
                        // output data of each row
                        while($row = $result->fetch_assoc()) {
                            echo "<tr class='textCertifieradeFtg'><td class='textCertifieradeFtg'>" . $row["company_name"]. "</td><td class='textCertifieradeFtg'>" . $row["city"]. "</td><td class='textCertifieradeFtg' width='200'>"  . $row["service_specialitet"].  "</td></tr>";
                        }
                    } else {

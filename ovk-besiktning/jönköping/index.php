...
<head lang="en">
    <meta charset="utf-8">
    	<meta name="description" content="Hitta företag som utför OVK i Jönköpingstrakten, Jönköpings län. Se översikt över ventilationskontroll och företags inriktning samt få kostnad och pris.">
    ...
    <title>OVK-besiktning i Jönköping, Jönköpings län - pris och kostnader</title>
...
<main>
    ...
    <div class="contentNytrMap">
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">OVK-besiktning i Jönköping</h1>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud != '' AND city ='Jönköping' OR city ='Huskvarna' OR city ='Bankeryd'";
      ...
      function setMarkers(map) {
        ...
        for (var i = 0; i < beaches.length; i++) {
		  ...
		  google.maps.event.addListener(marker, 'click', function() {
			...
			['OVK-besiktning Jönköpings län', 55.67,13.21, 20, '/assets/images/3-stars-icon.png', '/ovk-besiktning/Jönköpings län/'],  
			<?php 
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
                  <div class="faqAnswer articlesText"><strong><a href="/ovk-besiktning/jönköpings-län/">Övriga trakter i Jönköpings län</a></strong><br>
				<a href="/ovk-besiktning/jönköping/">OVK-besiktning Jönköping</a><br>
				<a href="/ovk-besiktning/eksjö-vetlanda/">OVK-besiktning Eksjö, Vetlanda</a><br>
				<a href="/ovk-besiktning/gislaved/">OVK-besiktning Gislaved</a><br><br>
				...
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade funktionskontrollanter verksamma i Jönköpingstrakten, Jönköpings län. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 id="OVKTable" class="h2">OVK-certifierade i trakten av Jönköping</h2>
			 <div id="results-wrapper">
                ...
                ?>
				  ...
				  <br><br>
				  Ovan visas några slumpvis valda företag som har OVK-certifierad personal i Jönköpingstrakten. 
  			 ...
  			 <div class="title2"><h2 class="h2">Offerförfrågan - få svar på pris och kostnad</h2></div>
 			    ...
 			    Exempelvis: 
                   ...
                   <ul class="mainUl">
                     <li>Vilka leverantörer finns i Jönköpingstrakten? </li>

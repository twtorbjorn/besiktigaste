...
<head lang="en">
    <meta charset="utf-8">
    	<meta name="description" content="Hitta företag som utför OVK i Helsingborgstrakten, Skåne. Se översikt över ventilationskontroll och företags inriktning samt få kostnad och pris.">
    ...
    <title>OVK-besiktning i Helsingborg, Skåne - pris och kostnader</title>
    ...
    <div class="headerContent">
		...
		<nav>      
                <span class="headerBreadcrumb">
                    <a href="/ovk-besiktning/blekinge/" class="headerLink">Blekinge</a>
                    <a href="/ovk-besiktning/karlskrona-ronneby/" class="headerLink">Karlskrona, Ronneby</a>
                    <a href="/ovk-besiktning/karlshamn-sölvesborg/" class="headerLink">Karlshamn, Sölvesborg</a>
...
<main>
    ...
    <div class="contentNytrMap">
			...
			<div><h2 class="h2">Besiktigaste.se - erbjudandet</h2></div>
                <div>
                  <ul class="mainUl">
                      ...
                      <li class="mainLiText"><strong>Lokalt</strong> - Leverantörer certifierade i Skåne</li>
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">OVK-besiktning i Helsingborg</h1>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud FROM Companies WHERE latitud !=  '' AND city = 'Helsingborg'  or city = 'Lund' or city = 'Trelleborg'";
      ...
      function setMarkers(map) {
        ...
        for (var i = 0; i < beaches.length; i++) {
		  ...
		  google.maps.event.addListener(marker, 'click', function() {
	        ...
	        var beaches = [ 
			['I3ahco service AB', 55.56,13.03, 60, '/assets/images/5-stars-icon.png', '/ovk-besiktning/skåne/i3ahco-service/'],
        	['OVK-besiktning Helsingborg', 56.13,14.28, 24, '/assets/images/3-stars-icon.png', '/ovk-besiktning/Helsingborg/'],
        	['OVK-besiktning Ystad', 55.53,13.89, 23, '/assets/images/3-stars-icon.png', '/ovk-besiktning/ystad/'],
        	['OVK-besiktning Helsingborg', 56.13,12.86, 22, '/assets/images/3-stars-icon.png', '/ovk-besiktning/helsingborg/'],
        	['OVK-besiktning Hässlehom', 56.26, 13.88, 21, '/assets/images/3-stars-icon.png', '/ovk-besiktning/hassleholm/'],    
			<?php 
				  if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
							...
							if ($ctr < 10) {
    						    ...
    						    if ($test < 20) {
    							  echo "['" . $row["company_name"]."', " . $row["latitud"].", " . $row["longitud"].", $z, '/assets/images/1-stars-icon.png', '/ovk-besiktning/skåne/'],\n";
    							} elseif (20 > $test and $test > 9) {
    							   echo "['" . $row["company_name"]."', " . $row["latitud"].", " . $row["longitud"].", $z, '/assets/images/2-stars-icon.png', '/ovk-besiktning/skåne/'],\n";
    							} elseif (30 > $test and $test > 19) {
    							    echo "['" . $row["company_name"]."', " . $row["latitud"].", " . $row["longitud"].", $z, '/assets/images/3-stars-icon.png', '/ovk-besiktning/skåne/'],\n";
    							} elseif (40 > $test and $test > 29) {
    							   echo "['" . $row["company_name"]."', " . $row["latitud"].", " . $row["longitud"].", $z, '/assets/images/4-stars-icon.png', '/ovk-besiktning/skåne/'],\n";
    							} elseif (50 > $test and $test > 39) {
    							   echo "['" . $row["company_name"]."', " . $row["latitud"].", " . $row["longitud"].", $z, '/assets/images/5-stars-icon.png', '/ovk-besiktning/skåne/'],\n";
    							} else {
    							   echo "['" . $row["company_name"]."', " . $row["latitud"].", " . $row["longitud"].", $z, '/assets/images/2-stars-icon.png', '/ovk-besiktning/skåne/'],\n";						
    							}
							}
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
                <div class="faqAnswer articlesText"><strong><a href="/ovk-besiktning/skåne/">Övriga trakter i Skåne</a></strong><br>
				<a href="/ovk-besiktning/malmö/">OVK-besiktning Malmö</a><br>
				<a href="/ovk-besiktning/helsingborg/">OVK-besiktning Helsingborg</a><br>
				<a href="/ovk-besiktning/kristianstad/">OVK-besiktning Kristianstad</a><br><br>
				...
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade funktionskontrollanter verksamma i Helsingborgstrakten, Skåne. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 id="OVKTable" class="h2">OVK-certifierade i trakten av Helsingborg</h2>
			 <div id="results-wrapper">
				...
				<?php
                   ...
                   $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND city = 'Helsingborg'  or city = 'Lund' or city = 'Trelleborg'";
                   $result = $conn->query($sql);	
				  ...
				  if ($result->num_rows > 0) {
                    ...
                    $conn->close();
                ?>
                  <!--<tr class='textCertifieradeFtg'><td class='textCertifieradeFtg'><a href="/ovk-besiktning/vastra-gotaland/hsb-goteborg">HSB Helsingborg</a> </td><td class='textCertifieradeFtg'>Helsingborg </td><td class='textCertifieradeFtg'>spec</td><td class='textCertifieradeFtg'><a href="/ovk-besiktning/vastra-gotaland/hsb-goteborg.php"><span style='color: orange;'><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i></a></td></tr> -->
				  </table>
				  ...
				  <br><br>
				  Ovan visas några slumpvis valda företag som har OVK-certifierad personal i Helsingborgstrakten. 
  			 ...
  			 <div class="title2"><h2 class="h2">Offerförfrågan - få svar på pris och kostnad</h2></div>
 			    ...
 			    Exempelvis: 
                   ...
                   <ul class="mainUl">
                     <li>Vilka leverantörer finns i Helsingborgstrakten? </li>

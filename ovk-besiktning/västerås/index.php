...
<head lang="en">
    <meta charset="utf-8">
    	<meta name="description" content="Hitta företag som utför OVK i Västeråsstrakten, Västmanland. Se översikt över ventilationskontroll och företags inriktning samt få kostnad och pris.">
    ...
    <title>OVK-besiktning i Västerås, Västmanland - pris och kostnader</title>
    ...
    <div class="headerContent">
		...
		<nav>      
                <span class="headerBreadcrumb">
                    <a href="/ovk-besiktning/västmanland/" class="headerLink">Västmanland</a>
                    <a href="/ovk-besiktning/västerås/" class="headerLink">/ Västerås</a>
                    <!--  <a href="/ovk-besiktning/varberg/" class="headerLink">/ Varberg</a>
                    <a href="/ovk-besiktning/falkenberg/" class="headerLink">/ Falkenberg</a>
...
<main>
    ...
    <div class="contentNytrMap">
        ...
        <div class="leftContentNytr">
			...
			<div><h2 class="h2">Besiktigaste.se - erbjudandet</h2></div>
                <div>
                  <ul class="mainUl">
                      ...
                      <li class="mainLiText"><strong>Lokalt</strong> - Leverantörer certifierade i Västmanland</li>
			...
			<div class="title2"><h2 class="h2">OVK-hantering i Västerås </h2></div>
				Byggnadsnämnden i Västerås kommun tillser att fastighetsägare inom kommunen följer lagens regler om obligatorisk ventilationskontroll. 
				Reglerna heter (SFS 1991:1273) BFS 2011:16 OVK 1. Nämnden håller register för varje fastighets senast genomförda OVK.     
				<br><br>
				Fastighetsägaren och den certifierade besiktningsman som genomfört OVK:n kommer överens om vem som skickar in besiktningsprotokollet till kommunens byggnadsnämnd. 
				När kommunen mottar protokollet förs det in i registret och fastighetsägaren behöver inte göra mer förrän nästa OVK-besiktningstillfälle. 

				 <br><br><b>Adress dit OVK-protokollet skickas:</b>
                
                  <ul class="mainUl">
                    Västerås stad<br>
                    Byggnadsnämnden<br>
                    Stadshuset rum A 403<br>
                    721 87 Västerås<br>
                  </ul>
			<br>	
				OVK-protokoll lyder under offentlighetsprincipen och kommunen ska <i>skyndsamt tillhandahålla protokoll när någon ur allmänheten efterfrågar</i>.

				 <br><br><b>Kontaktuppgifter för att efterfråga ett OVK-protokoll:</b>
                
                  <ul class="mainUl">
				  	Adress: Stadshuset
                    E-post: byggnadsnamnd(a)vasteras.se<br>
                    Telefon: 021-39 00 00<br>
                  </ul>
			<br>
			<a href='http://www.vasteras.se/naringsliv-och-arbete/tillstand-regler-och-tillsyn/ventilationskontroll.html' target='_blank'>Läs mer på Västerås kommuns hemsida</a>				
        </div>
		
        <div class="rightContentMap text-left">
  			 <h1 class="h2">OVK-besiktning i Västerås</h1>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND city ='Västerås'";
      ...
      function setMarkers(map) {
        ...
        for (var i = 0; i < beaches.length; i++) {
		  ...
		  google.maps.event.addListener(marker, 'click', function() {
			...
			['OVK-besiktning Västmanland', 55.67,13.21, 20, '/assets/images/3-stars-icon.png', '/ovk-besiktning/Västmanland/'],  
			<?php 
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
                  <div class="faqAnswer articlesText"><strong><a href="/ovk-besiktning/västmanland/">Övriga trakter i Västmanland</a></strong><br>
				<a href="/ovk-besiktning/västerås/">OVK-besiktning Västerås</a><br>
				 <!-- <a href="/ovk-besiktning/varberg/">OVK-besiktning Varberg</a><br>
				<a href="/ovk-besiktning/falkenberg/">OVK-besiktning Falkenberg</a><br> -->
				<br>
				...
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade funktionskontrollanter verksamma i Västeråsstrakten, Västmanland. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 id="OVKTable" class="h2">OVK-certifierade i trakten av Västerås</h2>
			 <div id="results-wrapper">
				...
				<?php
				   ...
				   include $includes . 'certifieradeTabell.php';
                    ...
                    $conn->close();
                ?>
                  <!--<tr class='textCertifieradeFtg'><td class='textCertifieradeFtg'><a href="/ovk-besiktning/västra-götaland/hsb-goteborg">HSB Västerås</a> </td><td class='textCertifieradeFtg'>Västerås </td><td class='textCertifieradeFtg'>spec</td><td class='textCertifieradeFtg'><a href="/ovk-besiktning/västra-götaland/hsb-goteborg.php"><span style='color: orange;'><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i></a></td></tr> -->
				  </table>
				  ...
				  <br><br>
				  Ovan visas några slumpvis valda företag som har OVK-certifierad personal i Västeråsstrakten. 
  			 ...
  			 <div class="title2"><h2 class="h2">Offerförfrågan - få svar på pris och kostnad</h2></div>
 			    ...
 			    Exempelvis: 
                   ...
                   <ul class="mainUl">
                     <li>Vilka leverantörer finns i Västeråsstrakten? </li>
			...
			<label class="faqTitle serviceTitle"><h2 class="h2">Fastighetsbesiktning - Kontrollanter</h2></label>
             <div class="articlesBlock">
                ...
                <div class="faqAnswer articlesText">Om du har ett företag som utför OVK, hissbesiktning eller utfärdar energideklarationer kan du kontakta besiktigaste.se. Vi presenterar alla certifierade kontrollanter. Det kostar ingenting. <br><br>
				</div>

...
<head lang="en">
    <meta charset="utf-8">
	<meta name="description" content="Hitta ett företag som utför OVK i Jönköpings läns län. Se en översikt över besiktningsmän, deras företags inriktning inom ventilation och läs andras omdömen.">
    ...
    <title>OVK-besiktning i Jönköpings län - hitta en besiktningsman, Besiktigaste.se</title>
...
<main>
    ...
    <div class="contentNytrMap">
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">OVK-besiktning Jönköpings län</h1>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud FROM Companies WHERE latitud !=  '' AND region = 'Jönköpings län' order by overallrating asc";
    ...
    <script>
      ...
      function initMap() {
        var map = new google.maps.Map(document.getElementById('map'), {
          zoom: 8,
          center: {lat: 57.5157, lng: 14.1388}
        });
      ...
      function setMarkers(map) {
        ...
        for (var i = 0; i < beaches.length; i++) {
		  ...
		  google.maps.event.addListener(marker, 'click', function() {
        	...
        	['Kinda sotning och ventilationsservice', 57.8374, 14.7734, 80, '/assets/images/5-stars-icon.png', '/ovk-besiktning/jönköpings-län/kinda-sotning-ventilationsservice/'], 
			<?php 
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
                  <div class="faqAnswer articlesText"><strong><a href="/ovk-besiktning/jönköpings-län/">Trakter i Jönköpings län</a></strong><br>
			 ...
			 <div id="results-wrapper">
				...
				<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND region = 'Jönköpings län' order by overallrating desc";
		    $result = $conn->query($sql);	

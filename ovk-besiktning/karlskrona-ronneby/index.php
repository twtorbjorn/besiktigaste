...
<head lang="en">
    <meta charset="utf-8">
    	<meta name="description" content="Hitta företag som utför OVK i Karlskrona, Ronnebystrakten, Blekinge. Se översikt över ventilationskontroll och företags inriktning samt få kostnad och pris.">
    ...
    <title>OVK-besiktning i Karlskrona, Ronneby, Blekinge - pris och kostnader</title>
...
<main>
    ...
    <div class="contentNytrMap">
			...
			<div><h2 class="h2">Besiktigaste.se - erbjudandet</h2></div>
                <div>
                  <ul class="mainUl">
                      ...
                      <li class="mainLiText"><strong>Lokalt</strong> - Leverantörer certifierade i Blekinge</li>
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">OVK-besiktning i Karlskrona, Ronneby</h1>
	...
	<?php
                   ...
                   $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND city = 'Karlskrona'  or city = 'Ronneby' or city = 'Mörrum'";
      ...
      function setMarkers(map) {
        ...
        for (var i = 0; i < beaches.length; i++) {
		  ...
		  google.maps.event.addListener(marker, 'click', function() {
	        ...
	        var beaches = [ 
			['I3ahco service AB', 55.56,13.03, 60, '/assets/images/5-stars-icon.png', '/ovk-besiktning/blekinge/i3ahco-service/'],
        	['OVK-besiktning Karlskrona, Ronneby', 56.13,14.28, 24, '/assets/images/3-stars-icon.png', '/ovk-besiktning/karlskrona-ronneby/'],
        	['OVK-besiktning Karlskrona, Ronneby', 56.13,12.86, 22, '/assets/images/3-stars-icon.png', '/ovk-besiktning/karlshamns-sölvesborg/'],
			<?php 
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
                <div class="faqAnswer articlesText"><strong><a href="/ovk-besiktning/blekinge/">Övriga trakter i Blekinge</a></strong><br>
				<a href="/ovk-besiktning/karlskrona-ronneby/">OVK-besiktning Karlskrona</a><br>
				<a href="/ovk-besiktning/karlskrona-ronneby/">OVK-besiktning Ronneby</a><br>
				<a href="/ovk-besiktning/karlshamn-sölvesborg/">OVK-besiktning Karlshamn</a><br>
				<a href="/ovk-besiktning/karlshamn-sölvesborg/">OVK-besiktning Sölvesborg</a><br><br>
				...
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade funktionskontrollanter verksamma i Karlskrona, Ronnebystrakten, Blekinge. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 id="OVKTable" class="h2">OVK-certifierade i trakten av Karlskrona, Ronneby</h2>
			 <div id="results-wrapper">
				...
				<?php
				  ...
				  if ($result->num_rows > 0) {
                    ...
                    $conn->close();
                ?>
                  <!--<tr class='textCertifieradeFtg'><td class='textCertifieradeFtg'><a href="/ovk-besiktning/vastra-gotaland/hsb-goteborg">HSB Karlskrona, Ronneby</a> </td><td class='textCertifieradeFtg'>Karlskrona, Ronneby </td><td class='textCertifieradeFtg'>spec</td><td class='textCertifieradeFtg'><a href="/ovk-besiktning/vastra-gotaland/hsb-goteborg.php"><span style='color: orange;'><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i></a></td></tr> -->
				  </table>
				  ...
				  <br><br>
				  Ovan visas några slumpvis valda företag som har OVK-certifierad personal i Karlskrona, Ronnebystrakten. 
  			 ...
  			 <div class="title2"><h2 class="h2">Offerförfrågan - få svar på pris och kostnad</h2></div>
 			    ...
 			    Exempelvis: 
                   ...
                   <ul class="mainUl">
                     <li>Vilka leverantörer finns i Karlskrona, Ronnebystrakten? </li>

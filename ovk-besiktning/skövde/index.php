...
<head lang="en">
    <meta charset="utf-8">
	<meta name="description" content="Hitta företag som utför OVK i trakten av Skövde, Mariestad och Lidköping, Västra Götalands län. Se översikt över ventilationskontroll och företags inriktning samt få kostnad och pris.">
    ...
    <title>OVK-besiktning i Skövde, Mariestad, Lidköping i Västergötland</title>
...
<main>
    ...
    <div class="contentNytrMap">
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">OVK-besiktning i Skövde, Mariestad</h1>
	...
	<?php
                   ...
                   $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND city ='Skövde' or city ='lidköping' or city ='mariestad' order by overallrating desc";
    ...
    <script>
      ...
      var beaches = [
        ['Bengt Dahlgren Skövde AB', 58.3930,13.8527, 20, '/assets/images/3-stars-icon.png', '#OVKTable'],
        ['Bravida Sverige AB', 58.7122,13.828, 24, '/assets/images/3-stars-icon.png', '#OVKTable'],
        ['Caverion Sverige AB', 58.696,13.815, 23, '/assets/images/3-stars-icon.png', '#OVKTable'],
        ['Creacon HK AB', 58.389,13.844, 22, '/assets/images/3-stars-icon.png', '#OVKTable'],
        ['Energiteknik AB', 58.3949,13.885, 26, '/assets/images/3-stars-icon.png', '#OVKTable'],
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
				...
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade funktionskontrollanter verksamma i trakten av Skövde-Mariestad, Västra Götaland. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 id="OVKTable" class="h2">OVK-certifierade kring Skövde-Mariestad</h2>
			 <div id="results-wrapper">
                ...
                ?>
				  ...
				  <br><br>
				  Ovan visas några slumpvis valda företag som har OVK-certifierad personal i trakten av Lidköping, Skövde, Mariestad. 
  			 ...
  			 <div class="title2"><h2 class="h2">Offerförfrågan - få svar på pris och kostnad</h2></div>
 			    ...
 			    Exempelvis: 
                   ...
                   <ul class="mainUl">
                     <li>Vilka leverantörer finns i Skövde-Mariestadstrakten? </li>

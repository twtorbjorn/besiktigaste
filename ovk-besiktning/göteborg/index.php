...
<main>
    ...
    <div class="contentNytrMap">
			...
			<div><h2 class="h2">Besiktigaste.se - erbjudandet</h2></div>
                <div>
                  <ul class="mainUl">
                      ...
                      <li class="mainLiText"><strong>Lokalt</strong> - Leverantörer certifierade i Västergötland</li>
		...
		<div class="title2"><h2 class="h2">OVK i Göteborg kommun </h2></div>
		
				<h4 class="h4">Ansvarig avdelning hos kommunen</h4>

					I <a href="http://goteborg.se/wps/portal/start/foretag/tillstand-och-regler/bygga/ventilation---ovk/!ut/p/z1/04_Sj9CPykssy0xPLMnMz0vMAfIjo8ziAwy9Ai2cDB0N_N0t3Qw8Q7wD3Py8fUzcTU30w8EKDFCAo4FTkJGTsYGBu7-RfhQx-vEoiMIwHtki_YLc0FAA2GGH5g!!/dz/d5/L2dBISEvZ0FBIS9nQSEh/" target="_blank">Göteborg kommun är det stadsbyggnadskontoret</a> som ansvarar för OVK. 
					Det är stadsbyggnadskontoret som ansvarar OVK-besiktning genomförs inom lagstadgad tid. Och att det är en certifierad kontrollant som ansvarar för besiktningen.
					<br><br>	
				<h4 class="h4">Register över fastigheter och OVK-protokoll</h4>
					
					För att registrera ett OVK-protokoll vänder du dig till stadsbyggnadskontoret. 
					Du mailar in protokollet till:<br> 
					<b>Email:</B> <a href="mailto:sbk@sbk.goteborg.se">sbk@sbk.goteborg.se</a>
					<br><br>	
					Den som är intresserad av någon specifik fastighet och när de senast genomförde en OVK kan maila sbk@sbk.goteborg.se för att be om information. Kommunen erbjuder inte fullständiga registerutdrag för alla fastigheter.  
					<br><br>	
				<h4 class="h4">Kortfakta</h4>
					
					I Göteborg och Mölndal kommun finns det 1630 BRF:er och i hela länet finns 350 006 villor och 58 647 fritidshus. 	 
		<!-- sluttag v kol -->		 
        </div>
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
                <div class="faqAnswer articlesText"><strong><a href="/ovk-besiktning/västra-götaland/">Övriga trakter i Västergötland</a></strong><br>
				<a href="/ovk-besiktning/göteborg/">OVK-besiktning Göteborg</a><br>
				<a href="/ovk-besiktning/borås/">OVK-besiktning Borås</a><br>
				<a href="/ovk-besiktning/trollhättan/">OVK-besiktning Trollhättan</a><br>
				<a href="/ovk-besiktning/skövde/">OVK-besiktning Skövde</a><br><br>
				...
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade funktionskontrollanter verksamma i Göteborgstrakten, Västergötland. 
			 ...
			 <div id="results-wrapper">
				...
				<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND city ='Göteborg' or city ='mölndal' order by overallrating desc";
				   $result = $conn->query($sql);	
				   ...
				   include $includes . 'certifieradeTabell.php';
                    ...
                    $conn->close();
                ?>
                  <!--<tr class='textCertifieradeFtg'><td class='textCertifieradeFtg'><a href="/ovk-besiktning/västra-götaland/hsb-goteborg">HSB Göteborg</a> </td><td class='textCertifieradeFtg'>Göteborg </td><td class='textCertifieradeFtg'>spec</td><td class='textCertifieradeFtg'><a href="/ovk-besiktning/västra-götaland/hsb-goteborg.php"><span style='color: orange;'><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i></a></td></tr> -->
				  </table>
				  ...
				  <br><br>
				  Ovan visas några slumpvis valda företag som har OVK-certifierad personal i Göteborgstrakten. 
  			 ...
  			 <div class="title2"><h2 class="h2">Offerförfrågan - få svar på pris och kostnad</h2></div>
 			    ...
 			    Exempelvis: 
                   ...
                   <ul class="mainUl">
                     <li>Vilka leverantörer finns i Göteborgstrakten? </li>

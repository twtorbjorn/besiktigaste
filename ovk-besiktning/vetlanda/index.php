...
<main>
    ...
    <div class="contentNytrMap">
			...
			<div><h2 class="h2">Varför använda tjänsten besiktigaste.se?</h2></div>
                <div>
                  <ul class="mainUl">
                      ...
                      <li class="mainLiText"><strong>Lokalt</strong> - Leverantörer certifierade i Vetlanda</li>
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">OVK-besiktning Vetlanda</h1>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud FROM Companies WHERE latitud !=  '' AND region = 'Jönköpings län'";
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
				...
				<a href="/ovk-besiktning/gislaved/">OVK-besiktning Eksjö</a><br><br>
			 ...
			 <h2 class="h2">OVK-certifierade i Vetlanda</h2>
		    ...
		    include $includes . 'certifieradeTabell.php';
  			 ...
  			 <div class="title2"><h2 class="h2">Vad får du svar på i din offerförfrågan?</h2></div>
 			    ...
 			    Exempelvis: 
                   ...
                   <ul class="mainUl">
                     <li>Vilka leverantörer finns i mitt Vetlanda? </li>

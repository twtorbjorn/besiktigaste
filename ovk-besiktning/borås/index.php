...
<head lang="en">
    <meta charset="utf-8">
	<meta name="description" content="Hitta företag som utför OVK i Boråstrakten, Västra Götalands län. Se översikt över ventilationskontroll och företags inriktning samt få kostnad och pris.">
    ...
    <title>OVK-besiktning i Borås, Västra Götaland - pris och kostnader</title>
...
<main>
    ...
    <div class="contentNytrMap">
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">OVK-besiktning i Borås</h1>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND city ='Borås' or city ='Ulricehamn' or city ='Kinna' or city ='Gånghester'";
    ...
    <script>
      ...
      var beaches = [
        ['Aircontrol', 57.726,12.9177, 20, '/assets/images/3-stars-icon.png', '#OVKTable'],
        ['Blomqvist Ventilation AB', 57.805,13.421, 24, '/assets/images/3-stars-icon.png', '#OVKTable'],
        ['KlimatService Kinna AB', 57.499,12.698, 23, '/assets/images/3-stars-icon.png', '#OVKTable'],
        ['VVS & Energi i Brämhult AB', 57.7211,12.941, 22, '/assets/images/3-stars-icon.png', '#OVKTable']
			<?php 
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
				...
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade funktionskontrollanter verksamma i Boråstrakten, Västra Götaland. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 id="OVKTable" class="h2">OVK-certifierade i trakten av Borås</h2>
			 <div id="results-wrapper">
                ...
                ?>
				  ...
				  <br><br>
				  Ovan visas några slumpvis valda företag som har OVK-certifierad personal i Boråstrakten. 
  			 ...
  			 <div class="title2"><h2 class="h2">Offerförfrågan - få svar på pris och kostnad</h2></div>
 			    ...
 			    Exempelvis: 
                   ...
                   <ul class="mainUl">
                     <li>Vilka leverantörer finns i Boråstrakten? </li>

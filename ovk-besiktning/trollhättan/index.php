...
<head lang="en">
    <meta charset="utf-8">
	<meta name="description" content="Hitta företag som utför OVK kring Trollhättan, Uddevalla och Vänersborg i Västergötland. Se översikt över ventilationskontroll och företags inriktning samt få kostnad och pris.">
    ...
    <title>OVK-besiktning i Trollhättan, Uddevalla, Vänersborg </title>
...
<main>
    ...
    <div class="contentNytrMap">
			...
			<div><h2 class="h2">Besiktigaste.se - erbjudandet</h2></div>
                <div>
                  <ul class="mainUl">
                      ...
                      <li class="mainLiText"><strong>Lokalt</strong> - Leverantörer certifierade i Västra Götaland</li>
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">OVK-besiktning i Trollhättan-Uddevalla</h1>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND city ='trollhättan' or city ='vänersborg' or city ='uddevalla'";
    ...
    <script>
      ...
      var beaches = [
        ['Halleröds ventilation och Radon', 58.3477, 11.9467, 20, '/assets/images/3-stars-icon.png', '#OVKTable'],
        ['Håvac Systems AB', 58.285, 12.284, 24, '/assets/images/3-stars-icon.png', '#OVKTable'],
        ['JJ-Ventservice', 58.2937, 12.3076, 23, '/assets/images/3-stars-icon.png', '#OVKTable'],
        ['Kyl o Värmepumpcenter', 58.3667, 11.969, 22, '/assets/images/3-stars-icon.png', '#OVKTable'],
        ['T Hedgren Energiteknik AB', 58.2896,12.3338, 25, '/assets/images/3-stars-icon.png', '#OVKTable']
			<?php 
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
                <div class="faqAnswer articlesText"><strong><a href="/ovk-besiktning/västra-götaland/">Övriga trakter i Västra Götaland</a></strong><br>
				<a href="/ovk-besiktning/göteborg/">OVK-besiktning Göteborg</a><br>
				<a href="/ovk-besiktning/borås/">OVK-besiktning Borås</a><br>
				<a href="/ovk-besiktning/trollhättan/">OVK-besiktning Trollhättan, Uddevalla</a><br>
				<a href="/ovk-besiktning/skövde/">OVK-besiktning Skövde, Mariestad, Lidköping </a><br><br>
				...
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade funktionskontrollanter verksamma i trakten kring Trollhättan, Uddevalla och Vänersborg i Västergötland. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 id="OVKTable" class="h2">OVK-certifierade kring Trollhättan, Uddevalla</h2>
			 <div id="results-wrapper">
                ...
                ?>
				  ...
				  <br><br>
				  Ovan visas några slumpvis valda företag som har OVK-certifierad personal i trakten av Trollhättan-Uddevalla. 
  			 ...
  			 <div class="title2"><h2 class="h2">Offerförfrågan - få svar på pris och kostnad</h2></div>
 			    ...
 			    Exempelvis: 
                   ...
                   <ul class="mainUl">
                     <li>Vilka leverantörer finns kring Uddevalla och Trollhättan? </li>

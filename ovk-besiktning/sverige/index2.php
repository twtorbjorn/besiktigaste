...
<main>
    ...
    <div class="contentNytrMap">
        ...
        <div class="leftContentNytr">
			...
			<?php 
				  include $root . '/assets/scripts/test2.php'; 
				  echo 'root: ' . $root . '<br>';
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">Regional OVK-besiktning - södra Sverige</h1>
			<?php 
				  //include '/../assets/scripts/test2.php'; 
				  echo 'root: ' . $root . '<br>';
				  echo 'includes:' .  $includes . '<br>';
				  echo 'paths:' . $paths . '<br>';  				   
			?>
      ...
      function setMarkers(map) {
        ...
        for (var i = 0; i < beaches.length; i++) {
		  ...
		  google.maps.event.addListener(marker, 'click', function() {
        	...
        	['OVK-besiktning Västra Götaland', 58.43,13.48, 24, '/assets/images/3-stars-icon.png', '/ovk-besiktning/västra-götaland/'],
        	['OVK-besiktning Jönköpings län', 57.99,14.99, 25, '/assets/images/3-stars-icon.png', '/ovk-besiktning/jönköpings-län/'],
        	['OVK-besiktning Kronobergs län', 57.33,15.19, 23, '/assets/images/3-stars-icon.png', '/ovk-besiktning/kronobergs-län/'],
        	['OVK-besiktning Halland', 57.13,13.26, 22, '/assets/images/3-stars-icon.png', '/ovk-besiktning/halland/'],
        	['OVK-besiktning Kalmar län', 57.13,16.96, 22, '/assets/images/3-stars-icon.png', '/ovk-besiktning/kalmar-län/'],
        	['OVK-besiktning Blekinge', 56.56, 15.49, 26, '/assets/images/3-stars-icon.png', '/ovk-besiktning/blekinge/']];    
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
                <div class="faqAnswer articlesText"><strong><a href="/ovk-besiktning/ventilationskontroll-sverige/">Södra Sveriges län</a></strong><br>
				<a href="/ovk-besiktning/västra-götaland/">OVK-besiktning Västra Götaland</a><br>
				<a href="/ovk-besiktning/jönköpings-län/">OVK-besiktning Jönköpings län</a><br>
				<a href="/ovk-besiktning/halland/">OVK-besiktning Halland</a><br>
				<a href="/ovk-besiktning/skåne/">OVK-besiktning Skåne</a><br>
				<a href="/ovk-besiktning/blekinge/">OVK-besiktning Blekinge</a><br><br>
				...
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade funktionskontrollanter verksamma i södra Sverige. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 id="OVKTable" class="h2">OVK-certifierade i södra Sverige</h2>
			 ...
			 <div id="results-wrapper">
				...
				<?php
				   ...
				   require 'certifieradeTabell.php';

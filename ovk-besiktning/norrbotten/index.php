...
<head lang="en">
    <meta charset="utf-8">
	<meta name="description" content="Hitta ett företag som utför OVK i Norrbottens län. Se en översikt över besiktningsmän, deras företags inriktning inom ventilation och läs andras omdömen.">
    ...
    <title>OVK-besiktning i Norrbotten - hitta en besiktningsman, Besiktigaste.se</title>
...
<main>
    ...
    <div class="contentNytrMap">
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">OVK-besiktning Norrbotten</h1>
    ...
    <script>
      ...
      function initMap() {
        var map = new google.maps.Map(document.getElementById('map'), {
          zoom: 6,
          center: {lat: 66.499, lng: 19.58666}
        });
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
                <div class="faqAnswer articlesText">
                <div class="faqAnswer articlesText"><strong><a href="/ovk-besiktning/norrbotten/">Trakter i Norrbotten</a></strong><br>
				...
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade funktionskontrollanter verksamma i Norrbotten. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 class="h2">OVK-certifierade i Norrbotten</h2>
		    ...
		    include $includes . 'certifieradeTabell.php';
  			 ...
  			 <div class="title2"><h2 class="h2">Vad får du svar på i din offerförfrågan?</h2></div>
 			    ...
 			    Exempelvis: 
                   ...
                   <ul class="mainUl">
                     <li>Vilka leverantörer finns i mitt Norrbotten? </li>

...
<head lang="en">
    <meta charset="utf-8">
	<meta name="description" content="Accent VVS konsult i Ystad utför OVK och erbjuder andra tjänster inom ventilation. Företaget är auktoriserad att sköta service och injustering av ventilation i fastigheter. Läs kunders omdömen om Accent VVS konsult.">
    ...
    <title>Accent VVS konsult AB - utför OVK besiktning i Ystad</title>
...
<main>
	...
	<div class="leftContentNytr2">
	             <h2 class="h2">Accent VVS konsult - leverantörslöftet</h2>
               
                <div>
                  <ul class="mainUl">
                      <li class="mainLiText"><strong>Certifierade</strong> - utför OVK-besiktning sedan 1996</li>
                      <li class="mainLiText"><strong>Ekonomi</strong> - kompletterar OVK med enklare service</li>
                      <li class="mainLiText"><strong>På plats</strong> - Ystad med omnejd</li>
                  </ul>
				</div>
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h1">Accent VVS konsult AB</h1>
			 <h4 class="title4">Ett teknikföretag inom innemiljö</h4>			
                ...
                – innemiljöutredning<br>
                – radonutredning<br>
                – energioptimering<br>
                – kontrollansvarig<br>
                – CE-märkning
                <br><br>
                Vänd er till Accent VVS konsult när ni behöver utföra ventilationsrelaterade arbeten i Ystadstrakten.
				</div>
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item carousel-indicators-bottom active">
                        ...
                        <div class="quotes-comments">
                                <p class="carusel-text">Vi använder Accent VVS sedan många år dels som konsult i energi frågor och i olika ovk ärende som besiktningar och efterföljande åtgärder. Inte alltid billigast men noggrann och det lönar sig i längden.
                        <img src="/assets/images/quotes.png"></p><br>
								
                                <p class="carusel-text black"><b>Niclas Johansson, Göteborg</b></p>
                         </div>
...
allt skall fungera i fastigheter samt är mycket kunnig och till slut trevlig att arbeta tillsammans med.
            ...
            <div class="articlesBlock">
                ...
                <a href="#userName" class="faqQuestion articlesLink">Kontaktinfo Accent VVS konsult</a>
                <div class="faqAnswer articlesText">
					<table><tr><td class='textCompanyPres'>OVK-certifierad:</td><td class='textCompanyPres'> Dennis Andersson </td></tr>
					<tr><td class='textCompanyPres'>Telefon:</td><td class='textCompanyPres'>031 - 707 30 80</td></tr>
					<tr><td class='textCompanyPres'>Email:</td><td class='textCompanyPres'>dennis.andersson@accentvvs.se</td></tr>
					<tr><td class='textCompanyPres'>Adress:</td><td class='textCompanyPres'> 
							Accent VVS konsult AB<br>
							Ystad<br>
						</td></tr>
					</table>
                </div>

...
<head lang="en">
    <meta charset="utf-8">
	<meta name="description" content="Hitta ett företag som utför OVK i Skåne län. Se en översikt över besiktningsmän, deras företags inriktning inom ventilation och läs andras omdömen.">
    ...
    <title>OVK-besiktning i Skåne - hitta en besiktningsman, Besiktigaste.se</title>
...
<div class="title2"><h2 class="h2">Vilka uppgifter behöver vi av dig?</h2></div>
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">OVK-besiktning Skåne</h1>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud FROM Companies WHERE latitud !=  '' AND region = 'Skåne' order by overallrating asc";
      ...
      function setMarkers(map) {
        ...
        for (var i = 0; i < beaches.length; i++) {
		  ...
		  google.maps.event.addListener(marker, 'click', function() {
	        ...
	        var beaches = [ 
			['OVK-besiktning Malmö', 55.67,13.21, 20, '/assets/images/5-stars-icon.png', '/ovk-besiktning/skåne/'],  
        	['OVK-besiktning Kristianstad', 56.13,14.28, 24, '/assets/images/3-stars-icon.png', '/ovk-besiktning/kristianstad/'],
        	['OVK-besiktning Ystad', 55.53,13.89, 23, '/assets/images/5-stars-icon.png', '/ovk-besiktning/skåne/accentvvs-konsult/'],
			...
			['Lindsells AB', 55.7741,12.9978, 61, '/assets/images/5-stars-icon.png', '/ovk-besiktning/skåne/lindsells/'],
			<?php 
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
				...
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade funktionskontrollanter verksamma i Skåne. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 class="h2">OVK-certifierade i Skåne</h2>
			 <div id="results-wrapper">
				...
				<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND region = 'Skåne' order by overallrating desc";
                    $result = $conn->query($sql);	
  			 ...
  			 <div class="title2"><h2 class="h2">Vad får du svar på i din offerförfrågan?</h2></div>
 			    ...
 			    Exempelvis: 
                   ...
                   <ul class="mainUl">
                     <li>Vilka leverantörer finns i mitt Skåne? </li>

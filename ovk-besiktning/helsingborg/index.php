...
<main>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND city = 'Helsingborg'  or city = 'Lund' or city = 'Landskrona'";

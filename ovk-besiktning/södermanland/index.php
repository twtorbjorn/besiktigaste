...
<head lang="en">
    <meta charset="utf-8">
	<meta name="description" content="Hitta ett företag som utför OVK i Södermanland. Se en översikt över besiktningsmän, deras företags inriktning inom ventilation och läs andras omdömen.">
    ...
    <title>OVK-besiktning i Södermanland - hitta en besiktningsman, Besiktigaste.se</title>
...
<main>
    ...
    <div class="contentNytrMap">
			...
			<div><h2 class="h2">Varför använda tjänsten besiktigaste.se?</h2></div>
                <div>
                  <ul class="mainUl">
                      ...
                      <li class="mainLiText"><strong>Lokalt</strong> - Leverantörer certifierade i Södermanland</li>
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">OVK-besiktning Södermanland</h1>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND region = 'Södermanland' order by overallrating desc";
    ...
    <script>
      ...
      function initMap() {
        var map = new google.maps.Map(document.getElementById('map'), {
          zoom:8,
          center: {lat: 59.0419, lng: 16.1074}
        });
      ...
      function setMarkers(map) {
        ...
        for (var i = 0; i < beaches.length; i++) {
		  ...
		  google.maps.event.addListener(marker, 'click', function() {
	        ...
	        var beaches = [ 
			['Ventilationsteknik AB', 58.7901,17.0341, 62, '/assets/images/5-stars-icon.png', '/ovk-besiktning/södermanland/ventilations-och-fastighetsteknik/'], 
			['Fastighetsteknik AB', 58.7201,17.0241, 64, '/assets/images/5-stars-icon.png', '/ovk-besiktning/södermanland/ventilations-och-fastighetsteknik/'], 
			<?php 
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
                <div class="faqAnswer articlesText">
                <div class="faqAnswer articlesText"><strong><a href="/ovk-besiktning/södermanland/">Övriga trakter i Södermanland</a></strong><br><br>
				...
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade funktionskontrollanter verksamma i Södermanland. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 class="h2">OVK-certifierade i Södermanland</h2>
		    ...
		    include $includes . 'certifieradeTabell.php';
  			 ...
  			 <div class="title2"><h2 class="h2">Vad får du svar på i din offerförfrågan?</h2></div>
 			    ...
 			    Exempelvis: 
                   ...
                   <ul class="mainUl">
                     <li>Vilka leverantörer finns i mitt Södermanland? </li>

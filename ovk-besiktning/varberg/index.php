...
<head lang="en">
    <meta charset="utf-8">
    	<meta name="description" content="Hitta företag som utför OVK i Varbergstrakten, Halland. Se översikt över ventilationskontroll och företags inriktning samt få kostnad och pris.">
    ...
    <title>OVK-besiktning i Varberg, Halland - pris och kostnader</title>
...
<main>
    ...
    <div class="contentNytrMap">
        ...
        <div class="rightContentMap text-left">
  			 <h1 class="h2">OVK-besiktning i Varberg</h1>
	...
	<?php
                    ...
                    $sql = "SELECT company_name, city, service_specialitet, overallrating, latitud, longitud, internal_url FROM Companies WHERE latitud !=  '' AND city ='Varberg'";
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Tu20mLrT31Q3C_tsWVv-T_1IBA3PrYQ&callback=initMap">
        ...
        <div class="rightContentLocal text-left">
				...
				Tjänsten är enkel och hjälper dig att snabbt få offerter från certifierade funktionskontrollanter verksamma i Varbergstrakten, Halland. 
				Det ger dig svar på frågor om vilka tjänster som erbjuds till fastighetsägare. Och vad de kostar.
				  
                </div> 
			 <h2 id="OVKTable" class="h2">OVK-certifierade i trakten av Varberg</h2>
			 <div id="results-wrapper">
				...
				<?php
				   ...
				   include $includes . 'certifieradeTabell.php';
                    ...
                    $conn->close();
                ?>
                  <!--<tr class='textCertifieradeFtg'><td class='textCertifieradeFtg'><a href="/ovk-besiktning/västra-götaland/hsb-goteborg">HSB Varberg</a> </td><td class='textCertifieradeFtg'>Varberg </td><td class='textCertifieradeFtg'>spec</td><td class='textCertifieradeFtg'><a href="/ovk-besiktning/västra-götaland/hsb-goteborg.php"><span style='color: orange;'><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i></a></td></tr> -->
				  </table>
				  ...
				  <br><br>
				  Ovan visas några slumpvis valda företag som har OVK-certifierad personal i Varbergstrakten. 
  			 ...
  			 <div class="title2"><h2 class="h2">Offerförfrågan - få svar på pris och kostnad</h2></div>
 			    ...
 			    Exempelvis: 
                   ...
                   <ul class="mainUl">
                     <li>Vilka leverantörer finns i Varbergstrakten? </li>
